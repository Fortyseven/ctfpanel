...
module.exports = function (grunt) {
    ...
    lesscfg["build"]["files"][path_dest_css + "/main.css"] =
        path_src_css + "/main.less";
    ...
    var watch_opts = {
        root: {
            files: [
                config.path.source.root +
                    config.path.source.top_level +
                    "/**/*",
            ],
            tasks: ["copy"],
        },
        images: {
            files: [
                config.path.source.root + config.path.source.images + "/**/*",
            ],
            tasks: ["copy:images"],
        },
        fonts: {
            files: [
                config.path.source.root + config.path.source.fonts + "/**/*",
            ],
            tasks: ["copy:fonts"],
        },
        js: {
        ...
        styles: {
            files: [
                config.path.source.root + config.path.source.css + "/**/*.less",
            ],
            tasks: ["less"],
        },
        pages: {
